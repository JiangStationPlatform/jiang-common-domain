package cn.jiang.station.platform.common.domain;
...
public class TbPostsPost extends BaseDomain{
     ...
     * 获取剪裁后不带尺寸的正文图片数组
     *
     * @return original_images - 剪裁后不带尺寸的正文图片数组
     */
     ...
     * 设置剪裁后不带尺寸的正文图片数组
     *
     * @param originalImages 剪裁后不带尺寸的正文图片数组
     */
     ...
     * 获取剪裁前的正文图片数组
     *
     * @return full_size_images - 剪裁前的正文图片数组
     */
     ...
     * 设置剪裁前的正文图片数组
     *
     * @param fullSizeImages 剪裁前的正文图片数组
     */
